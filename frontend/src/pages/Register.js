    ...
    <>
      ...
      <div className="p-20">
        ...
        <form action="http://localhost:8000/register" method="POST">
          ...
          <input name="passwordTwo" value={user.passwordTwo} onChange={(e)=>{handleChange(e)}} type="password" placeholder="Re-enter the password" className="w-64 border-b-2 block mt-2 mb-3 outline-none focus:border-blue-300 hover:border-gray-300 cursor-pointer transition-colors" />
          <div className="flex items-center mb-5">
            <p className="w-64">do you want to create an account for the author</p>
            <input type="checkbox" onClick={(e)=>{checkboxChange(e)}}  name="authorPermissions" placeholder="Enter" />
          </div>
